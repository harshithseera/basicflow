...
BasicFlow is an alternative, computationally light implementation of the pipeline for SteadyFlow based on "SteadyFlow: Spatially Smooth Optical Flow for Video Stabilization" by Shuaicheng Liu, Lu Yuan, Ping Tan, Jian Sun.
